...
impl OpenAIResponsesBuilder {
    ...
    pub fn build(self) -> Result<OpenAIResponsesLanguageModel<crate::reqwest_transport::ReqwestTransport>, SdkError> {
...
fn build_openai(
    ...
    let transport_cfg =
        build_provider_transport_config(def, Some(Duration::from_secs(45)));
