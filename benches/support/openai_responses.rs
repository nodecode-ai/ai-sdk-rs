...
pub fn openai_responses_config() -> OpenAIConfig {
    OpenAIConfig {
...
pub fn openai_request_scenarios() -> [(&'static str, v2t::CallOptions); 2] {
    [
        ("simple_text", simple_call_options()),
        ("tool_heavy", tool_heavy_call_options()),
    ]
}

pub fn openai_stream_fixtures() -> &'static [&'static str] {
    &[
