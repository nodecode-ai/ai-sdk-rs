...
use crate::providers::google::shared::prepare_tools::{
...
impl<T: HttpTransport> GoogleGenAiLanguageModel<T> {
    ...
    fn build_body(
        ...
        if let Some(raw_google_opts) = options.provider_options.get("google") {
            ...
            {
                crate::core::options::deep_merge(&mut generation_config, &gen_cfg_extra);
            }
...
impl GoogleGenAiLanguageModel<crate::transport_reqwest::ReqwestTransport> {
